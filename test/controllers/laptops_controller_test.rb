...
class LaptopsControllerTest < ActionController::TestCase
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post :create, laptop: { btype: @laptop.btype, product_id: @laptop.product_id, weight: @laptop.weight }
    end
  ...
  test "should update laptop" do
    patch :update, id: @laptop, laptop: { btype: @laptop.btype, product_id: @laptop.product_id, weight: @laptop.weight }
    assert_redirected_to laptop_path(assigns(:laptop))
  end
