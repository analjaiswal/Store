...
class CreditcardsControllerTest < ActionController::TestCase
  ...
  test "should create creditcard" do
    assert_difference('Creditcard.count') do
      post :create, creditcard: { ccaddress: @creditcard.ccaddress, cctype: @creditcard.cctype, expdate: @creditcard.expdate, ownername: @creditcard.ownername, secnumber: @creditcard.secnumber }
    end
  ...
  test "should update creditcard" do
    patch :update, id: @creditcard, creditcard: { ccaddress: @creditcard.ccaddress, cctype: @creditcard.cctype, expdate: @creditcard.expdate, ownername: @creditcard.ownername, secnumber: @creditcard.secnumber }
    assert_redirected_to creditcard_path(assigns(:creditcard))
  end
