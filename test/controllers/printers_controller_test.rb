...
class PrintersControllerTest < ActionController::TestCase
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post :create, printer: { printertype: @printer.printertype, product_id: @printer.product_id, resolution: @printer.resolution }
    end
  ...
  test "should update printer" do
    patch :update, id: @printer, printer: { printertype: @printer.printertype, product_id: @printer.product_id, resolution: @printer.resolution }
    assert_redirected_to printer_path(assigns(:printer))
  end
